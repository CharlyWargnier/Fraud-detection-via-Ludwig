...
with st.form(key="my_form"):
    ...
    # with c3:
    slider = st.slider("How many Epochs?", 2, 3)
    # with c5:
...
fig = visualize.learning_curves(
    [data],
    output_directory="/app/fraud-detection-via-ludwig",
    file_format="png",
)

st.image(
    "/app/fraud-detection-via-ludwig/learning_curves_isfraud_accuracy.png",
    use_column_width=True,
)
st.image(
    "/app/fraud-detection-via-ludwig/learning_curves_isfraud_loss.png",
    use_column_width=True,
)

st.image(
    "/app/fraud-detection-via-ludwig/learning_curves_isfraud_hits_at_k.png",
    use_column_width=True,
)
# with c1:
st.image(
    "/app/fraud-detection-via-ludwig/learning_curves_combined_loss.png",
    use_column_width=True,
)
